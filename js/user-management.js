...
function abrirFormularioNuevoUsuario() {
    ...
    c.innerHTML=`<section style="background:white;border:1px solid #cbd5e1;border-top:5px solid #7c3aed;border-radius:14px;padding:16px"><h2 style="margin:0 0 13px;font-size:17px">CREAR NUEVO USUARIO</h2><div style="display:grid;grid-template-columns:1fr 1fr;gap:10px"><label>NOMBRE COMPLETO<input id="gu-nuevo-nombre" maxlength="150" style="width:100%;box-sizing:border-box;padding:9px;margin-top:4px"></label><label>USUARIO<input id="gu-nuevo-usuario" maxlength="40" placeholder="ej. jperez" style="width:100%;box-sizing:border-box;padding:9px;margin-top:4px"></label><label>PERFIL<select id="gu-nuevo-rol" style="width:100%;padding:9px;margin-top:4px">${roles}</select></label><label>CONTRASEÑA TEMPORAL<input id="gu-nuevo-clave" type="password" minlength="8" autocomplete="new-password" style="width:100%;box-sizing:border-box;padding:9px;margin-top:4px"></label><label>REPETIR CONTRASEÑA<input id="gu-nuevo-clave2" type="password" minlength="8" autocomplete="new-password" style="width:100%;box-sizing:border-box;padding:9px;margin-top:4px"></label></div><p style="font-size:9px;color:#64748b">Entrega la contraseña temporal directamente al usuario. No quedará visible después de crear la cuenta.</p><div style="display:flex;gap:8px"><button onclick="crearNuevoUsuarioAdmin()" style="flex:2;border:0;border-radius:9px;background:#7c3aed;color:white;padding:10px;font-weight:900">CREAR CUENTA</button><button onclick="renderDetalleGestionUsuario()" style="flex:1;border:1px solid #cbd5e1;border-radius:9px;background:white">CANCELAR</button></div></section>`;
}
