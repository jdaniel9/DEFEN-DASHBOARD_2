...
//   sistemas            → administra exclusivamente el modulo de Radios
//   gdp                 → consulta exclusivamente Asistencia
...
function usuarioTieneModuloExclusivo() {
    return ['central_monitoreo', 'sistemas', 'gdp'].includes(rolActual());
}
...
function aplicarPermisosUI() {
    ...
    const moduloExclusivo = usuarioTieneModuloExclusivo();
