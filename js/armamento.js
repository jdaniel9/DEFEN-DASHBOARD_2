...
function histMovUrl(valor) { try { const u=new URL(String(valor||''),location.href);if(!['http:','https:'].includes(u.protocol))return '';if(u.hostname.endsWith('supabase.com')&&u.pathname.includes('/dashboard/'))return '';return histMovEsc(u.href); } catch(_) { return ''; } }
