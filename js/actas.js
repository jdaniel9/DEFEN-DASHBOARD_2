...
function mostrarPestanaActas(vista){
    const historial=vista==='historial',pendientes=vista==='pendientes',transito=vista==='transito',retorno=vista==='retorno',nueva=!historial&&!pendientes&&!transito&&!retorno;
    ...
    [['acta-tab-nueva',nueva],['acta-tab-historial',historial],['acta-tab-pendientes',pendientes],['acta-tab-transito',transito],['acta-tab-retorno',retorno]].forEach(([id,activo])=>{const e=document.getElementById(id);if(e)e.style.cssText=`border:0;border-radius:8px;padding:7px 12px;font-size:11px;font-weight:900;cursor:pointer;${activo?'background:#f97316;color:white':'background:#e2e8f0;color:#334155'}`;});
