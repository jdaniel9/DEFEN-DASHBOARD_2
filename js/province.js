    ...
    header.innerHTML = `
        <div class="flex-1 min-w-0">
            ...
            <div class="flex gap-1.5 mt-0.5 flex-wrap items-center">
                <span class="text-[9px] text-slate-500 font-semibold">👮${proyecto.guardias} ${typeof usuarioEsCentralMonitoreo === 'function' && usuarioEsCentralMonitoreo() ? '' : `🔫${proyecto.armas} `}🏢${proyecto.puestos ?? '—'}</span>
